...
MODEL_ARTIFACT_ROOT = Path(
    config("MODEL_ARTIFACT_ROOT", default="/var/lib/cchis/model_artifacts")
)
...
SOURCE_DATA_DHIS2_API_TOKEN = config("SOURCE_DATA_DHIS2_API_TOKEN", default="")
SOURCE_DATA_DHIS2_MAPPING_JSON = config("SOURCE_DATA_DHIS2_MAPPING_JSON", default="")
SOURCE_DATA_DHIS2_QUERY_JSON = config("SOURCE_DATA_DHIS2_QUERY_JSON", default="")
SOURCE_DATA_DHIS2_TIMEOUT_SECONDS = config("SOURCE_DATA_DHIS2_TIMEOUT_SECONDS", cast=int, default=30)
SOURCE_DATA_DHIS2_MAX_RETRIES = config("SOURCE_DATA_DHIS2_MAX_RETRIES", cast=int, default=2)
