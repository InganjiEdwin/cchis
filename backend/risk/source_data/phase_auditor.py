...
PHASE_AUDIT_CONTRACT: tuple[PhaseAuditContract, ...] = (
    ...
    PhaseAuditContract(
        ...
        checks=(
            ...
            _artifact(
                ...
                "test_dry_validation_rejects_composite_pii_headers_before_domain_validation",
                "test_dry_validation_scans_trailing_cells_not_named_by_headers",
    ...
    PhaseAuditContract(
        ...
        checks=(
            ...
            _artifact(
                ...
                "Source-data page has stable operator components for feeds, staged upload/validation, review, readiness, operations, connectors, roles, refresh, and accessibility.",
                "SourceDataPage",
                "DataReadinessTabs",
                "FeedCard",
                "friendlyTruthLabel",
            ...
            _artifact(
                ...
                "Frontend tests cover source-data feed truth, staged upload/validation/review, readiness, scoped health failures, role controls, refresh, downstream behavior, and accessible tabs.",
                "SourceDataPage",
                "renders a data-readiness workspace with template download links",
                "surfaces backend feed provenance, freshness and connector evidence",
                "keeps unconfigured and demo-backed feeds truthfully labelled",
                "validates required fields and rejected files before upload",
                "applies last-used metadata and submits a clean upload payload",
                "renders readiness-specific validation summary",
                "keeps operations failure scoped to its panel and does not claim overall production health",
                "never reports healthy when any required operations metric is missing",
                "renders safe downstream actions after an imported upload",
                "runs downstream actions with sourceCutoffTimestampForUpload instead of browser time",
                "lets analysts inspect templates and current status without upload controls",
                "denies CHV access to the Source Data workspace",
                "refreshes the feed registry, overview, operations and upload queries together",
    ...
    PhaseAuditContract(
        ...
        checks=(
            ...
            _artifact(
                ...
                "test_connector_refresh_options_use_same_pii_safe_metadata_guard",
    ...
    PhaseAuditContract(
        ...
        checks=(
            ...
            _artifact(
                10,
                "phase10_source_data_admin_inspection",
                "backend/risk/admin.py",
                "Django admin registers source-data and readiness source models for superuser inspection and emergency debugging.",
                "SourceDataUploadBatchAdmin",
                "SourceDataUploadArtifactAdmin",
                "SourceDataValidationIssueAdmin",
                "SourceDataUploadEventAdmin",
                "SourceDataConnectorRunAdmin",
                "FacilityReadinessIngestionRunAdmin",
                "FacilityReadinessSnapshotAdmin",
            ),
            _artifact(
                10,
