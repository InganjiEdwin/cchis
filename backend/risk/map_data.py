        ...
        features.append(
            {
                ...
                "properties": {
                    ...
                    "current_risk_level": ward.current_risk_level if ward else None,
                    "current_risk_score": ward.current_risk_score if ward else None,
                    ...
                    "prediction": {
                        "available": latest_risk is not None,
                        "horizon_days": 7,
                        "predicted_risk_level": latest_risk.risk_level if latest_risk else None,
                        "predicted_risk_score": latest_risk.score if latest_risk else None,
                        "predicted_cases": latest_risk.predicted_cases if latest_risk else 0,
                        "prediction_generated_at": latest_risk.generated_at.isoformat() if latest_risk else None,
                        "prediction_model_version": latest_risk.model_version if latest_risk else None,
                    },
                    "trend": trend,
